...
public class MusicBand {
    ...
    public static Semaphore guitarReady;
    public static Semaphore singerReady;
    public static int guitar;
    public static int singer;

    public static void init() {
        //TODO: da se implementira
        guitarReady = new Semaphore(3);
        singerReady = new Semaphore(2);
        singer = 0;
        guitar = 0;
    }
    ...
    public static class GuitarPlayer extends TemplateThread {
        ...
        public void execute() throws InterruptedException {
            ...
            synchronized (TemplateThread.class) {
                guitar++;
                if (singer == 2 && guitar == 3) {
                    state.evaluate();
                    singer = 0;
                    guitar = 0;
                    guitarReady.release(3);
                    singerReady.release(2);
                }
            }
        }
